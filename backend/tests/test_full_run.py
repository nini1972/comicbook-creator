...
def test_full_comic_generation():
    ...
    # Simple test topic that should generate quickly
    test_topic = "A brave cat who wants to fly"
...
if __name__ == "__main__":
    exit_code = test_full_comic_generation()
    sys.exit(exit_code)
